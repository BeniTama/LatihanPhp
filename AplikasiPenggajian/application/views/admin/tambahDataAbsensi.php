...
<div class="container-fluid">
    ...
    <div class="alert alert-info">
        Menamilkan Data Kehadiran Pegawai Bulan: <span class="font-weight-bold"><?= $bulan; ?></span> Tahun: <span class="font-weight-bold"><?= $tahun; ?></span>
    </div>
    ...
    <form method="POST">
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php $no = 1;
            foreach ($input_absensi as $ia) : ?>
                <tr>
                    <input type="hidden" name="bulan[]" class="form-control" value="<?= $bulantahun; ?>">
                    <input type="hidden" name="nik[]" class="form-control" value="<?= $ia->nik; ?>">
                    <input type="hidden" name="nama_pegawai[]" class="form-control" value="<?= $ia->nama_pegawai; ?>">
                    <input type="hidden" name="jenis_kelamin[]" class="form-control" value="<?= $ia->jenis_kelamin; ?>">
                    <input type="hidden" name="nama_jabatan[]" class="form-control" value="<?= $ia->nama_jabatan; ?>">
                    <td><?= $no++; ?></td>
                    <td><?= $ia->nik; ?></td>
                    <td><?= $ia->nama_pegawai; ?></td>
